...
$($SCL removetrigger powershades_udp-api)
$($SCL removetrigger powershades_udp-api-b)
$($SCL removetrigger powershades_udp-api-v2)
$($SCL removetrigger powershades_udp-api-v2b)
